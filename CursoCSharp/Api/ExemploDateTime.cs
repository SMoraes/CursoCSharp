...
namespace CursoCSharp.Api
{
    internal class ExemploDateTime
    {
        public static void Executar()
        {
            ...
            Console.WriteLine("Hora: " + diaAtual.Minute);
            Console.WriteLine("Hora: " + diaAtual.Second);

            var amanha = diaAtual.AddDays(1);
            Console.WriteLine("Dia de amanhã: " + amanha);

            var ontem = diaAtual.AddDays(-1);
            Console.WriteLine("Dia de ontem: " + ontem);
